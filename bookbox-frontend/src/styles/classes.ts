...
//My account overlay styles
export const myAccountOverlayImageStyle = "absolute left-0 right-0 bottom-0 z-0";
export const fillCoverImageStyle = "w-full h-20 object-cover";
export const myAccountOverlayContentBaseStyle = "bg-[var(--base-secondary-light)] rounded-2xl shadow-2xl p-6 max-w-4xl relative pb-22 overflow-hidden"
export const myAccountOverlayCloseButtonStyle = "text-gray-500 hover:text-black text-4xl absolute top-4 right-4 z-20 inline-flex items-center justify-center";
